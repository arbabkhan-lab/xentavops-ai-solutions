...
const Footer = () => {
  const socialLinks = [
    { icon: Facebook, href: 'https://xentavops.com/socialmedia.html' },
    { icon: Instagram, href: 'https://xentavops.com/socialmedia.html' },
    { icon: Twitter, href: 'https://xentavops.com/socialmedia.html' },
    { icon: Linkedin, href: 'https://xentavops.com/socialmedia.html' },
    { icon: Youtube, href: 'https://xentavops.com/socialmedia.html' },
  ];
